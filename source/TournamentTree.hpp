...
void Replacemax(vector<node>& tree, int newVal, double &counter);        // funkcja wstawiająca nową wartość na miejsce starego maximum drzewa turniejowego
...
void Replacemax(vector<node>& tree, int newVal, double& counter) {
